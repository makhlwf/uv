...
<p align="center">
  <picture align="center">
    ...
    <img alt="An image of a horizontal bar chart showing the performance of different tools: uv, poetry, pdm, and pip-sync. Each tool has a purple bar representing its execution time, and the time is displayed to the right of each bar.  The tool uv has the shortest execution time, 0.06s, indicated by a very short purple bar. Poetry's execution time is 0.99s, with a bar slightly longer than uv's. PDM's execution time is 1.90s, and its bar is longer than poetry's. Pip-sync has the longest execution time at 4.63s, represented by the longest bar in the chart. The x-axis is labeled with time intervals in seconds, showing 0s, 2s, and 4s. The background of the chart is dark, and the text and bars are in contrasting colors to make them easily visible." src="https://github.com/astral-sh/uv/assets/1309177/629e59c0-9c6e-4013-9ad4-adb2bcf5080d">
  </picture>
</p>
